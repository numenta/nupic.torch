...
class KWinnersBase(nn.Module, metaclass=abc.ABCMeta):
    ...
    def __init__(
        ...
        self.register_buffer("boost_strength", torch.tensor(boost_strength,
                                                            dtype=torch.float))
        self.boost_strength_cpu = boost_strength
    ...
    def update_boost_strength(self):
        ...
        """
        self.boost_strength_cpu *= self.boost_strength_factor
        self.boost_strength.fill_(self.boost_strength_cpu)
